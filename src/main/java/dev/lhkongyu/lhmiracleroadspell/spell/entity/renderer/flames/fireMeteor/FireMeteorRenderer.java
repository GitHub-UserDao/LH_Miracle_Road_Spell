package dev.lhkongyu.lhmiracleroadspell.spell.entity.renderer.flames.fireMeteor;
...
public class FireMeteorRenderer extends EntityRenderer<Projectile> {
    ...
    public FireMeteorRenderer(Context context, float scale) {
        super(context);
