...
public class FireMeteorProjectile extends CommonMagicProjectile {
    public FireMeteorProjectile(EntityType<? extends FireMeteorProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public FireMeteorProjectile(Level pLevel, LivingEntity pShooter) {
        this(EntityRegistry.FIRE_METEOR_PROJECTILE.get(), pLevel);
        this.setOwner(pShooter);
    }

    private final int flameParticleAmount = 20;

    private final int trailParticlesAmount = 4;
