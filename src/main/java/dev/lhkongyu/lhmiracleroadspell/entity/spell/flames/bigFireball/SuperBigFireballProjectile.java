...
public class SuperBigFireballProjectile extends CommonMagicProjectile {
    public SuperBigFireballProjectile(EntityType<? extends SuperBigFireballProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public SuperBigFireballProjectile(Level pLevel, LivingEntity pShooter) {
        this(EntityRegistry.SUPER_BIG_FIREBALL_PROJECTILE.get(), pLevel);
